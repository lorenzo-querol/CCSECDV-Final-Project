    ...
    return (
        ...
        >
            ...
            <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                {/* <!--  Gray Background --> */}
                <div className="fixed inset-0 transition-opacity bg-gray-600 bg-opacity-80" aria-hidden="true"></div>
                ...
                <div className="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                    <div className="flex flex-row items-center justify-between p-4">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <h1 className="my-2 ml-4 text-xl font-bold leading-6 text-gray-900 uppercase">User Logs</h1>
                        </div>
                    ...
                    {/* <!--  Bottom --> */}
                    <div className="flex flex-row-reverse justify-between p-2 sm:px-6 sm:flex sm:flex-row-reverse"></div>
                </div>
            </div>
        </div>
    );
