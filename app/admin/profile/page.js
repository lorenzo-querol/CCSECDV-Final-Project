...
import { AiFillCloseCircle, AiFillHeart, AiOutlineArrowLeft, AiOutlineHeart, AiOutlineMessage } from 'react-icons/ai';
// Icons
import { BiDotsVerticalRounded, BiImage, BiSearch, BiVideoPlus } from 'react-icons/bi';
            ...
            <div className="flex flex-row h-full overflow-y-auto">
                ...
                <div className="w-4/6 h-full border-t-0 border-gray-600 border-x-2">
                    ...
                    <div className="flex justify-between w-full h-10">
                        <button className="w-1/2p text-xl font-bold hover:bg-indigo-700">Posts</button>
                        <button className="w-1/2 text-xl font-bold hover:bg-indigo-700">Likes</button>
                    </div>
                    ...
                    <ul className="list-none">
                        ...
                        <li className="border-b-2 border-gray-600 ">
                            ...
                            {/* Post: content */}
                            <div className="pl-16">
                                <p className="flex-shrink w-auto text-base font-medium text-white">post.description</p>
                                    ...
                                    <div className="w-full">
                                        <div className="flex items-center">
                                            <div className="flex flex-col items-center justify-center flex-1 py-2 m-2 text-center">
                                                <button className="flex items-center w-12 px-3 py-1 mt-1 text-base font-medium leading-6 text-red-500 rounded-full group">
                                                    <AiFillHeart size={25} />
                                                </button>
                                                {/* Only show if there's at least 2 likes */}
                                                <span className="text-sm text-gray-200">post.heart_count</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
