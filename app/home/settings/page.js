...
export default function Settings() {
	...
	const handleDeactivateAccount = () => {
		try {
			password: watchPassword, console.log("Account deactivated successfully!");
						...
						<div className="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
							...
							<div className="flex flex-col mx-10 my-2 text-gray-500">
								<p className="mb-2 text-sm text-gray-500 font-raleway">
									Please note that after confirming the deactivation of your
									account, you will not be allowed to retrieved it. Kindly
									confirm the deactivation by inputting your current password.{" "}
								</p>
								<div className="flex flex-col">
									<div
										className={styles.input_group}
